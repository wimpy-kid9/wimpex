      ...
      <div className="mx-auto flex min-h-screen max-w-2xl items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-md border border-hairline bg-panel-2/95 p-8 text-center shadow-2xl shadow-black/40 sm:p-10">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <a className="inline-flex rounded-2xl bg-gradient-to-r from-gold to-gold-deep px-6 py-3 text-sm font-semibold text-slate-950 transition hover:brightness-110" href={redirectUrl || 'https://id.wimpy-corp.com.ng/login'}>
              Continue to WimpyID
            </a>
