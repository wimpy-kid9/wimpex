      ...
      <div className="mx-auto flex min-h-screen max-w-2xl items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-md border border-hairline bg-panel-2/95 p-8 text-center shadow-2xl shadow-black/40 sm:p-10">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {redirectUrl ? (
              <a className="inline-flex rounded-2xl bg-gradient-to-r from-gold to-gold-deep px-6 py-3 text-sm font-semibold text-obsidian transition hover:brightness-110" href={redirectUrl}>
                Continue to WimpyID
              </a>
            ) : (
              <span className="inline-flex rounded-2xl bg-gold/30 px-6 py-3 text-sm font-semibold text-obsidian/50">
                Continue to WimpyID
              </span>
            )}
