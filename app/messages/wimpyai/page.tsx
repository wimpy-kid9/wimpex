...
export default function WimpyAIChat() {
  ...
  return (
    <main className="fixed inset-x-0 top-0 bottom-[calc(5.5rem+env(safe-area-inset-bottom))] md:left-72 md:bottom-0 overflow-hidden flex flex-col px-4 pt-6 pb-3 sm:px-6 lg:px-8 md:pb-6">
