      ...
      <div className="surface-veil mx-auto max-w-3xl rounded-md border border-hairline bg-panel-2/80 p-8 shadow-2xl shadow-black/30 sm:p-10">
        ...
        <div className="mt-8 rounded-md border border-hairline bg-panel/70 p-5">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <a href={signupUrl || 'https://id.wimpy-corp.com.ng/signup'} className="rounded-md bg-gradient-to-r from-gold to-gold-deep px-5 py-3 text-sm font-semibold text-slate-950 transition hover:brightness-110">
              Continue to WimpyID
            </a>
