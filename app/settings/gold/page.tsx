...
export default function GoldSettingsPage() {
  ...
  const [hideFeedNudges, setHideFeedNudges] = useState(false);
  ...
  useEffect(() => {
    const load = async () => {
      ...
      setHideFeedNudges(Boolean(profilePayload.profile?.gold_feed_nudges_hidden));
